...
This project aims to automate the process for creating reports on repetitive lab experiments (Mainly provided by [AU_team](https://au-team.ru/)
...
- **Умный ввод данных**
  - Выбор из предустановленных дисциплин:
    ...
    3. Ручной ввод произвольной дисциплины
...
- **Работа с изображениями**  
  ...
  - Форматирование подписей: "Рисунок 1 — Описание..."
...
1. Подготовка директории:
  - Поместить шаблон отчета (.docx|.doc) с плейсхолдерами.
  - Добавить изображения для отчета, добавление происходит в соответствии с сортировкой по имени.
2. Запуск системы:
```python
automato.py
```
...
- Выбрать шаблон (при наличии нескольких)
4. Обработка изображений.
- Просмотр изображений в порядке их именования
- Ввод описаний для каждого рисунка (описание отображается под рисунком в формате "Рисунок # — (Описание)"
5. Генерация отчета.
